...
func (m *MsgSelectRandomChallenger) GetMultiplier() string {
	if m != nil {
		return m.Multiplier
	}
	return ""
...
type MsgSelectRandomChallengerResponse struct {
	RandomChallenger string `protobuf:"bytes,1,opt,name=randomChallenger,proto3" json:"randomChallenger,omitempty"`
}
...
func (m *MsgSelectRandomChallengerResponse) GetRandomChallenger() string {
	if m != nil {
...
var fileDescriptor_8ac16a0aed23c2e2 = []byte{
	...
	,
}
...
func (m *MsgSelectRandomChallengerResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RandomChallenger) > 0 {
		i -= len(m.RandomChallenger)
		copy(dAtA[i:], m.RandomChallenger)
		i = encodeVarintTx(dAtA, i, uint64(len(m.RandomChallenger)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgSelectRandomChallengerResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.RandomChallenger = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
