...
import (
	...
	soar "github.com/amirh39/soarchain-core/app"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		//startProxyForTunneledPeers(initClientCtx, cmd) check this
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig params.EncodingConfig) {
	...
	rootCmd.AddCommand(
		...
		genutilcli.ValidateGenesisCmd(soar.ModuleBasics),
		tmcli.NewCompletionCmd(rootCmd, true),
		tmcmds.RollbackStateCmd, //A state rollback is performed to recover from an incorrect application state transition,
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		keys.Commands(soar.DefaultNodeHome),
	)
	// add rosetta
...
func queryCommand() *cobra.Command {
	...
	soar.ModuleBasics.AddQueryCommands(cmd)
...
func txCommand() *cobra.Command {
	...
	soar.ModuleBasics.AddTxCommands(cmd)
	cmd.PersistentFlags().String(flags.FlagChainID, "", "The network chain ID")
