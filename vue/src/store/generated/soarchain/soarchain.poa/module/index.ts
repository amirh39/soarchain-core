...
import { MsgV2NChallenge } from "./types/poa/tx";
...
const types = [
  ...
  ["/soarchain.poa.MsgV2NChallenge", MsgV2NChallenge],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgV2NChallenge: (data: MsgV2NChallenge): EncodeObject => ({ typeUrl: "/soarchain.poa.MsgV2NChallenge", value: MsgV2NChallenge.fromPartial( data ) }),
