...
type MsgGenDpr struct {
	...
	SupportedPIDs  *SupportedPIDs `protobuf:"bytes,2,opt,name=supportedPIDs,proto3" json:"supportedPIDs,omitempty"`
...
func (m *MsgGenDpr) GetSupportedPIDs() *SupportedPIDs {
	if m != nil {
...
func (m *MsgGenDpr) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
type MsgEnterDpr struct {
	...
	SupportedPIDs *SupportedPIDs `protobuf:"bytes,3,opt,name=supportedPIDs,proto3" json:"supportedPIDs,omitempty"`
}
...
func (m *MsgEnterDpr) GetSupportedPIDs() *SupportedPIDs {
	if m != nil {
		return m.SupportedPIDs
	}
	return nil
...
var fileDescriptor_dec6b5e510091bca = []byte{
	...
	,
}
